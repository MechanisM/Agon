				...
				<div id="respond">
					...
					<div class="formcontainer">	
						<form id="commentform" action="?f=comment" method="post">
                            ...
                            <div id="form-section-human" class="form-section">
    							<div class="form-label"><label for="comment">What is two plus three?</label></div>
    							<div class="form-textarea"><textarea id="human" name="human" cols="45" rows="8" tabindex="6"></textarea></div>
                            </div>
